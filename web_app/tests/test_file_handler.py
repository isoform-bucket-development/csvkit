...
class TestFileUploadHandler:
    """Test suite for FileUploadHandler class"""

    @pytest.fixture
    def handler(self):
        """Create FileUploadHandler instance"""
...
"""
    ...
    def test_detect_encoding_latin1(self, handler, latin1_csv_file):
        ...
        assert encoding in handler.SUPPORTED_ENCODINGS
    ...
    def test_file_metadata_extraction(self, handler, sample_csv_file):
        """Test extraction of file metadata (encoding, delimiter, size)"""
        is_valid, message, df = handler.validate_and_load(sample_csv_file)
